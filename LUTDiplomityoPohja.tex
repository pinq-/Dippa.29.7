...
\begin{document}
\sloppy %Tasainen sanojen väli
\makecover %Luo kannen
...
\begin{tiivis}% #Jos sivu numerot eivät täsmää oman tiedoston kanssa niin tarksita \Temptalteen diplomityön lopussa. Komento tallentaa sivujen, kuvien ja taulukkojen määrän ennen liitteitä. 
...
\renewcommand\contentsname{ } %Sisällysluettelo on kirjoitettu jo ylös. Tämä poistaa automaattisen sisällysluettelon
...
\vspace*{\fill}%siiretään kappale mahdollisimman alas sivua 
...
\end{tabular}
\end{table}
%Tämä talukko on katkaistu manuaalisesti, jotta saadaan halutun lainen. Jos mahdollista, käytä longtable versiota. Esimerkki liitteessä II
...
\newpage
\renewcommand\refname{LÄHTEET} %Lähteet otsikko
%jotta hyper linkki toimisi on lisättävä phanttomi ja pitää lisää manuaalsiesti lähteet oiso sisällysluetteloon 
\phantomsection
\begin{thebibliography}{99}
\addcontentsline{toc}{section}{LÄHTEET} %Lisää sisällysluetteloon lähteet osion
...
%tallettaa kuvien, taulukkojen ja sivujen määrän ennen liitetiedostoja. Lisää tämä osio dipan loppuun, ennen liitteitä.
\TempTalteen
...
\appendix %liitetiedostojen tyyli

\section{Projektisuunnitelma}
\addtocounter{page}{1}%jos haluat sivu numeroinnin alkavan yhdellä, lisää tämä jokaisen liitteen alkuun.
...
\hline \multicolumn{1}{|c|}{\textbf{Ensimmäinen sarake}} & \multicolumn{1}{c|}{\textbf{Toinen sarake}} & \multicolumn{1}{c|}{\textbf{Kolmas sarake}} \\ \hline 
\endfirsthead
...
\hline \multicolumn{3}{|c|}{{Jatkuu seuraavalle sivulle}} \\ \hline
\endfoot
...
\end{tabular}
\end{table}
\kuva{0.4}{opiskelija}{Opiskelija tekemässä harjoitustyötä \citep[s. 90]{Leino00}.}{kala2}
kala 
...
\end{tabular}
\end{table}
\kuva{0.4}{opiskelija}{Opiskelija tekemässä harjoitustyötä \citep[s. 90]{Leino00}.}{kala3}



\newpage
\section{}
\kuva{0.4}{opiskelija}{Opiskelija tekemässä harjoitustyötä \citep[s. 90]{Leino00}.}{kala4}
...
%Aseta tämä osio ennen documentin loppua
\Talteen
\newpage %Tämä pitää olla jotta viimeisen liitten numerointi menee oikein. Älä kysy.
\end{appendices}
